1. Go to dojo.soy/mini-trinket and click Remix. You will need to be signed in to Trinket. After you've clicked Remix, click the **Save** button.
...
{% callout %}To learn how to do more with your website and earn yourself a digital badge, visit [dojo.soy/begin-sushi-websites](http://dojo.soy/begin-sushi-websites) and try the Beginner HTML CSS Sushi cards!
{% endcallout %}
